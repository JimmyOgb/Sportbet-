...
import { Trophy, Wallet, BarChart3 } from "lucide-react";

const matches = [
  { team1: "Arsenal", team2: "Chelsea", odds1: 2.1, odds2: 3.4 },
  { team1: "Real Madrid", team2: "Barcelona", odds1: 1.9, odds2: 2.8 },
  { team1: "Lakers", team2: "Warriors", odds1: 2.3, odds2: 2.0 },
];

export default function SportsBettingSite() {
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <header className="flex items-center justify-between mb-8">
        <h1 className="text-3xl font-bold">Sportbet</h1>
